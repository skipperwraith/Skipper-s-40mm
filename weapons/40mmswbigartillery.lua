...
FireEffect = path .. "/effects/fire_40mmbigartillery.lua"
...
Recoil = 800000
EnergyFireCost = 2400 --2000
MetalFireCost = 120 --100
DoorCloseDelay = 1.25
...
Sprites =
{
	...
	{
		Name = "bigartillery40mmsw-barrel",
		States =
		{
			Normal = { Frames = { { texture = path .. "/weapons/40mmcannon/40mmcannonbarrel.tga" }, mipmap = true, }, },
			Idle = Normal,
		},
	},
	{
		Name = "bigartillery40mmsw-reload",
		States =
		{
...
Root =
{
	...
	Pivot = { 0, -0.55 },
	PivotOffset = { 0, 0 },
	Sprite = "bigartillery40mmsw-base",
	UserData = 0,
	...
	{
		{
			...
			Pivot = { 0.1, -0.2 },
			PivotOffset = { 0.1, 0 },
			Sprite = "bigartillery40mmsw-head",
			UserData = 50,
			...
			{
				{
					...
					Sprite = "bigartillery40mmsw-barrel",
					UserData = 100,
				...
				},
				{
					...
					Pivot = { -0.515, -0.3},
					PivotOffset = { 0.35, 0 },
					Sprite = "bigartillery40mmsw-reload",
					UserData = 100,
				},
			},
		},
