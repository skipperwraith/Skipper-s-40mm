...
Sprites =
{
	...
	{
		Name = "munitionssw-base",
		States =
		{
			Normal = { Frames = { { texture = path .. "/devices/tier4munitionssw/base.tga" }, mipmap = true, }, },
		},
	},
}
...
Root =
{
	...
	ChildrenBehind =
	{
		...
		},
		{
			...
			Pivot = { 0.05, 0.08 },
			PivotOffset = { 0, 0 },
			Sprite = "MunitionsswWorker",
		},
		{
			Name = "SteamMunitionssw",
			Angle = 0,
			Pivot = { 0.15, -0.2 },
			PivotOffset = { 0, 0 },
		},
